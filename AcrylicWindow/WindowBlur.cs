    ...
    public class WindowAccentCompositor
    {
        ...
        private void _window_Deactivated(object? sender, EventArgs e)
        {
            _window.Background = new SolidColorBrush(
                DarkMode ? Color.FromArgb(255, 32, 32, 23) : Color.FromArgb(255, 242, 242, 242)
            );
        }
        ...
        static extern int DwmSetWindowAttribute(IntPtr hwnd, DWMWINDOWATTRIBUTE dwAttribute, ref int pvAttribute,
            int cbAttribute);
